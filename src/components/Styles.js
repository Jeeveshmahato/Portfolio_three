export const sectionStyles = {
  section: "relative max-w-7xl mx-auto px-6 py-12",
  sectionHeadText: "text-4xl sm:text-5xl lg:text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500",
  sectionSubText: "text-sm uppercase tracking-wider text-cyan-400 mb-2",
  sectionContent: "mt-12",

      ...
      >
        <div className="flex flex-col lg:flex-row items-center  lg:gap-[120px] gap-[10px] w-full">
          ...
          >
            ...
            >
              I create immersive{" "}
              <span className={sectionStyles.sectionSubText}>3D visuals</span>,
              elegant{" "}
              ...
              . With expertise in React, Next.js, and Three.js, I build scalable
          ...
          {/* Right Column - Canvas */}
          <img className="w-72 h-72 rounded-full object-cover order-1 lg:order-2"
              src={myImg}
              alt="Jeevesh Mahato"
            />
          {/* <motion.div

...
const projects = [
  {
    name: "Maitri App",
    description:
      "A full-stack matchmaking platform (Tinder for Professionals) with Tinder-style swipe matching powered by Framer Motion, 24-hour ephemeral stories with Cloudinary media uploads, a social post feed for connections, and real-time chat via Socket.io. Features JWT + OAuth (Google/GitHub) authentication, protected routes with Redux state management, Razorpay premium subscriptions, SES-powered email digests with cron scheduling, and a fully responsive mobile-first design. Deployed on AWS EC2 with Nginx reverse proxy and Cloudflare SSL.",
    tags: [
